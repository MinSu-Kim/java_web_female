...
CREATE TABLE proj_rentCar.insurance (
	...
	car_type CHAR(4)    NULL     COMMENT '차종', -- 차종
	price    INTEGER    NULL     COMMENT '보험료' -- 보험료
)
COMMENT '보험';
...
CREATE TABLE proj_rentCar.level (
	grade   VARCHAR(20) NOT NULL COMMENT '등급', -- 등급
	g_range INTEGER     NOT NULL COMMENT '등급범위' -- 등급범위
)
COMMENT '회원등급기준';
