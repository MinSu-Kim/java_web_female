...
CREATE TABLE proj_rentcar.brand (
	no   INT(11)     NOT NULL COMMENT '브랜드번호', -- 브랜드번호
...
CREATE TABLE proj_rentcar.car_model (
	car_code        CHAR(10)    NOT NULL COMMENT 's수동 a 자동 ,hy01:carType,ga연료 ,bk색상', -- s수동 a 자동 ,hy01:carType,ga연료 ,bk색상
	...
	one_hour        INT(11)     NOT NULL COMMENT '1시간비용', -- 1시간비용
...
ALTER TABLE proj_rentcar.car_model
	ADD CONSTRAINT
		PRIMARY KEY (
			car_code -- s수동 a 자동 ,hy01:carType,ga연료 ,bk색상
		);
...
CREATE TABLE proj_rentcar.car_type (
	...
	brand_code INT(11)     NOT NULL COMMENT '브랜드번호', -- 브랜드번호
...
CREATE TABLE proj_rentcar.level (
	bronze TINYINT(4) NOT NULL COMMENT '0-6', -- 0-6
	sliver TINYINT(4) NOT NULL COMMENT '7-40', -- 7-20
	gold   TINYINT(4) NOT NULL COMMENT '40-' -- 21
)
COMMENT '회원등급기준';
...
-- 차종(소 중 대)
ALTER TABLE proj_rentcar.car_type
	ADD CONSTRAINT FK_brand_TO_car_type -- FK_brand_TO_car_type
		FOREIGN KEY (
			brand_code -- 브랜드번호
		)
	...
	ADD INDEX FK_brand_TO_car_type (
		brand_code -- 브랜드번호
	);
